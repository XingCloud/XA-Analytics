...
class Analytics.Views.ReportTabs.PanelView extends Backbone.View
  template: JST["backbone/templates/report_tabs/report_tab_panel"]
  events:
...
class Analytics.Views.ReportTabs.ShowRangePickerView extends Backbone.View
  template: JST['backbone/templates/report_tabs/report_tab_show_range_picker']
  events:
...
class Analytics.Views.ReportTabs.CustomRangeView extends Backbone.View
  template: JST["backbone/templates/report_tabs/report_tab_show_custom_range"]
