...
class Analytics.Views.Metrics.FormListItemView extends Backbone.View
  ...
  template: JST['backbone/templates/metrics/metric_form_list_item']
  tagName: 'div'
  ...
  copy: () ->
    ...
    if cloned.get("combine_attributes")?
      ...
      cloned.get("combine_attributes")["project_id"] = if Instances.Models.project then Instances.Models.project.id else null
...
class Analytics.Views.Metrics.FormListView extends Backbone.View
  template: JST['backbone/templates/metrics/metric_form_list']
